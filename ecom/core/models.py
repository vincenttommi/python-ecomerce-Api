...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    accountType = models.CharField(max_length=20, choices=[('user', 'User'), ('admin', 'Admin'), ('instructor', 'Instructor')], default='user')
...
class OneTimePassword(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)  # Fix type here
    is_active = models.BooleanField(default=True)
